...
Revenue depends on product sales and is calculated by joining the **Order Items** table.
...
One seller can fulfill multiple products across many customer orders.
...
The same product may be sold by different sellers.
...
### Q6. Why do Customers and Sellers have similar location information?

Both customers and sellers participate in the logistics process.
...
Therefore, geographical information is required for both entities.

---

### Q7. Is Sellers a transaction table?

No.

It is a **master (dimension) table** that stores descriptive information about sellers.
